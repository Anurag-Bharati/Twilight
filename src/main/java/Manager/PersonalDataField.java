 ...
 * <p>API_TOKEN - is token to use the API<br>
 * MASTER_GMAIL - is sender's gmail<br>
 * MASTER_PASS - is sender's gmail password<br>
 * DATABASE_USER - is database user name<br>
 * DATABASE_PASS - is database password<br>
 * </p>
